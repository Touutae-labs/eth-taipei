...
// Contract addresses
const DAILY_SAVING_CONTRACT_ADDRESS = "0x7f88a4818b03053cb04d984d4e9abe576afa10d0";
...
const Home = () => {
  ...
  // Common test tokens
  const commonTokens = [
    { name: "ZRT", address: "0x4f0dfc7a638AA3f9b26F5aeA7f086526B269d53E" },
  ];
    ...
    const checkEIP7702Support = async () => {
      ...
      try {
        ...
        setSupportsEIP7702(
          ...
          capabilities.includes('eth_sendTransaction7702')
        );
      } catch (error) {
        // If error, assume no support
        console.log("EIP-7702 not supported by this wallet");
            ...
            <>
              ...
              <div className="bg-base-200 p-6 rounded-lg">
                <h2 className="text-xl font-bold mb-4">
                  Create Savings Plan
                  {useSmartAccount && supportsEIP7702 && <span className="badge badge-primary ml-2">Smart Account</span>}
                </h2>
